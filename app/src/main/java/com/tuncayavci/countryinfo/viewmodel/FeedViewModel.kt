...
import com.tuncayavci.countryinfo.services.CountryAPIService
import com.tuncayavci.countryinfo.services.CountryDatabase
import com.tuncayavci.countryinfo.util.CustomSharedPreferences
...
class FeedViewModel(application: Application) : BaseViewModel(application) {
    ...
    private fun storedInSQLite(list : List<Country>){
        launch {
